    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен в обработку'), ('PRD', 'обрабатывается'), ('PD', 'оплачен'), ('RD', 'готов к выдаче'), ('CNC', 'отменен'), ('DVD', 'выдан')], default='FM', max_length=3, verbose_name='статус')),
